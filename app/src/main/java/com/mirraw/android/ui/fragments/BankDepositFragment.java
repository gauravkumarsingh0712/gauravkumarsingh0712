 ...
 */
public class BankDepositFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.bank_deposit_fragment, container, false);
    ...
    private View initViews(View v) {
        ...
        v.findViewById(R.id.bankDepositPay).setEnabled(true);
        v.findViewById(R.id.bankDepositPay).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void createOrder(String pay_type) {
        mProgressDialog = ProgressDialog.show(getActivity(), "Please wait ...", "Creating " + pay_type + " Order ...", true);
