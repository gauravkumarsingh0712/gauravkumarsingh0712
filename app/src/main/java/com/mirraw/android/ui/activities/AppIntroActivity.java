...
public class AppIntroActivity extends BaseActivity {
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                if(i == index){
                    circle.setColorFilter(getResources().getColor(R.color.black_color));
                }else {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = ProductTourFragment.newInstance(R.layout.app_intro_fragment_one);
                    break;
                case 1:
                    tp = ProductTourFragment.newInstance(R.layout.app_intro_fragment_two);
                    break;
                case 2:
                    tp = ProductTourFragment.newInstance(R.layout.app_intro_fragment_one);
                    break;
    ...
    public class CrossfadePageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            View object8 = page.findViewById(R.id.a001);
            View object9 = page.findViewById(R.id.a002);
            View object10 = page.findViewById(R.id.a000);
            View object11 = page.findViewById(R.id.a001);
            View object12 = page.findViewById(R.id.a002);
            View object13 = page.findViewById(R.id.a000);
